"""
从 structured_output.jsonl + png 构建 64x64 像素数据集
feature 为 one-hot + 归一化连续值
使用 JSON + npy 格式保存，避免 HuggingFace datasets 版本兼容问题
"""
import os
import json
import shutil
...
# 路径配置
# =========================
JSONL_PATH = "/root/newmemsdata/structured_output1.jsonl"
STATS_PATH = "/root/newmemsdata/stats1.json"
PNG_DIR = "/root/memsdata/train/png"
SAVE_DIR = "/root/newmemsdata/mems_dataset_feature_64_test1"

IMG_SIZE = 64

# 用于构建 feature 向量的 key
FEATURE_KEYS = {
    "onehot": ["parasitic_type_id", "nonlinearity_id"],
    "continuous": [
        "drive_freq_minmax",
        "x_stiffness_minmax",
...
N_PARASITIC_TYPE = 3   # lt / between / gt
N_NONLINEARITY = 7
